...
public class Billing {
  ...
  record LatePenalty(Integer value) {}

  record LumpSumCompensation(Integer value) {}

  record DiscountAdvancePayment(Integer value) {}

  record FinalizedFile(String id, String url, String relativeUrl) {}
}
